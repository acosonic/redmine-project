...
ActiveRecord::Schema.define(:version => 20150208105930) do
  ...
  create_table "attachments", :force => true do |t|
    ...
    t.string   "filename",       :limit => 4000, :default => "", :null => false
    t.string   "disk_filename",  :limit => 4000, :default => "", :null => false
    t.integer  "filesize",                       :default => 0,  :null => false
    t.string   "content_type",   :limit => 4000, :default => ""
    t.string   "digest",         :limit => 40,   :default => "", :null => false
    t.integer  "downloads",                      :default => 0,  :null => false
    t.integer  "author_id",                      :default => 0,  :null => false
    t.datetime "created_on"
    t.string   "description",    :limit => 4000
    t.string   "disk_directory", :limit => 4000
  end
  ...
  create_table "auth_sources", :force => true do |t|
    ...
    t.integer "port"
    t.string  "account",           :limit => 4000
    t.string  "account_password",  :limit => 4000, :default => ""
    t.string  "base_dn"
  ...
  create_table "boards", :force => true do |t|
    ...
    t.string  "name",            :limit => 4000, :default => "", :null => false
    t.string  "description",     :limit => 4000
  ...
  create_table "changes", :force => true do |t|
    ...
    t.text    "from_path"
    t.string  "from_revision", :limit => 4000
    t.string  "revision",      :limit => 4000
  ...
  create_table "changesets", :force => true do |t|
    ...
    t.string   "revision",      :limit => 4000, :null => false
    t.string   "committer",     :limit => 4000
    t.datetime "committed_on",                  :null => false
    t.text     "comments"
    t.date     "commit_date"
    t.string   "scmid",         :limit => 4000
    t.integer  "user_id"
  end
  ...
  create_table "custom_fields", :force => true do |t|
    ...
    t.string  "regexp",          :limit => 4000, :default => ""
  ...
  create_table "easy_page_available_modules", :force => true do |t|
    t.integer "easy_pages_id"
    t.integer "easy_page_modules_id"
  end

  create_table "easy_page_available_zones", :force => true do |t|
    t.integer "easy_pages_id"
    t.integer "easy_page_zones_id"
    t.integer "position",           :default => 1
  end

  create_table "easy_page_modules", :force => true do |t|
  ...
  create_table "easy_page_template_modules", :id => false, :force => true do |t|
  ...
  add_index "easy_page_template_modules", ["uuid"], :name => "idx_easy_page_template_modules_2", :unique => true

  create_table "easy_page_templates", :force => true do |t|
    t.integer "easy_pages_id"
  ...
  create_table "easy_page_zone_modules", :id => false, :force => true do |t|
  ...
  add_index "easy_page_zone_modules", ["uuid"], :name => "idx_easy_page_zone_modules_2", :unique => true

  create_table "easy_page_zones", :force => true do |t|
    t.string "zone_name", :null => false
  end

  create_table "easy_pages", :force => true do |t|
    t.string "page_name",   :null => false
    t.string "layout_path", :null => false
  end

  create_table "easy_permissions", :force => true do |t|
  ...
  create_table "easy_settings", :force => true do |t|
    t.string  "name"
    t.text    "value"
    t.integer "project_id"
  end

  create_table "easy_user_allocations", :id => false, :force => true do |t|
    t.integer "user_id",             :null => false
    t.text    "allocation_timeline"
  end

  add_index "easy_user_allocations", ["user_id"], :name => "index_easy_user_allocations_on_user_id", :unique => true

  create_table "email_addresses", :force => true do |t|
    t.integer  "user_id",                                       :null => false
    t.string   "address",    :limit => 4000,                    :null => false
    t.boolean  "is_default",                 :default => false, :null => false
  ...
  create_table "issue_relations", :force => true do |t|
    ...
    t.string  "relation_type", :limit => 4000, :default => "", :null => false
    t.integer "delay"
  end
  ...
  create_table "issues", :force => true do |t|
    ...
    t.integer  "project_id",                                               :null => false
    t.string   "subject",               :limit => 4000, :default => "",    :null => false
    t.text     "description"
    t.date     "due_date"
    ...
    t.float    "estimated_hours",       :limit => 53
    t.integer  "parent_id"
    t.integer  "root_id"
    t.integer  "lft"
    t.integer  "rgt"
  ...
  create_table "news_users", :id => false, :force => true do |t|
    t.integer "user_id", :null => false
  ...
  create_table "open_id_authentication_associations", :force => true do |t|
    t.integer "issued"
    t.integer "lifetime"
    t.string  "handle",     :limit => 4000
    t.string  "assoc_type", :limit => 4000
    t.binary  "server_url"
    t.binary  "secret"
  end
  ...
  create_table "open_id_authentication_nonces", :force => true do |t|
    ...
    t.string  "server_url", :limit => 4000
    t.string  "salt",       :limit => 4000, :null => false
  end

  create_table "projectqueries", :force => true do |t|
    t.string  "name",          :default => "",    :null => false
    t.text    "filters"
    t.integer "user_id",       :default => 0,     :null => false
  ...
  create_table "projects", :force => true do |t|
    t.string   "name",                                  :default => "",    :null => false
    t.text     "description"
    t.string   "homepage",              :limit => 4000, :default => ""
    t.boolean  "is_public",                             :default => true,  :null => false
    t.integer  "parent_id"
    t.datetime "created_on"
    t.datetime "updated_on"
    t.string   "identifier",            :limit => 4000
  ...
  create_table "repositories", :force => true do |t|
    t.integer  "project_id",                    :default => 0,     :null => false
    t.string   "url",           :limit => 4000, :default => "",    :null => false
    t.string   "login",         :limit => 60,   :default => ""
    t.string   "password",      :limit => 4000, :default => ""
  ...
  create_table "time_entries", :force => true do |t|
    ...
    t.integer  "user_id",                   :null => false
    t.integer  "issue_id"
    t.float    "hours",       :limit => 53, :null => false
    t.string   "comments"
  ...
  create_table "userqueries", :force => true do |t|
    t.string  "name",          :default => "",    :null => false
    t.text    "filters"
    t.integer "user_id",       :default => 0,     :null => false
    t.boolean "is_public",     :default => false, :null => false
  ...
  create_table "users", :force => true do |t|
    t.string   "login",              :limit => 4000, :default => "",    :null => false
    ...
    t.string   "mail_notification",  :limit => 4000, :default => "",    :null => false
    t.string   "salt",               :limit => 64
    t.boolean  "must_change_passwd",                 :default => false, :null => false
    t.datetime "passwd_changed_on"
    t.string   "cached_group_names",                 :default => "",    :null => false
    t.integer  "parent_id"
    t.integer  "lft"
    t.integer  "rgt"
  end
  ...
  create_table "versions", :force => true do |t|
    t.integer  "project_id",                      :default => 0,      :null => false
    t.string   "name",            :limit => 4000, :default => ""
    t.string   "description",     :limit => 4000, :default => ""
    t.date     "effective_date"
    t.datetime "created_on"
    t.datetime "updated_on"
    t.string   "wiki_page_title", :limit => 4000
    t.string   "status",          :limit => 4000, :default => "open"
    t.string   "sharing",         :limit => 4000, :default => "none", :null => false
  end
  ...
  create_table "watchers", :force => true do |t|
    t.string  "watchable_type", :limit => 4000, :default => "", :null => false
  ...
  create_table "wiki_redirects", :force => true do |t|
    ...
    t.string   "redirects_to",         :limit => 4000
    t.datetime "created_on",                           :null => false
